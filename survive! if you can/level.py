...
class Level:
    def __init__(self,level_data,surface): 
        ...
        self.SFX_bullet = pygame.mixer.Sound('D:/survive! if you can/SFX and music/bullet.wav')
        self.SFX_drone_hitted = pygame.mixer.Sound('D:/survive! if you can/SFX and music/player_hitted.wav')
        self.SFX_metal = pygame.mixer.Sound('D:/survive! if you can/SFX and music/metal.wav')

        self.game_end = False
        self.checker_text = False
        tile_image =  pygame.image.load('D:\\survive! if you can\\graphics\\sprite\\wall.png').convert_alpha()
    ...
    def run(self):
        ...
        if player.status == 'death' and time.time() - self.death_time >= delay_death_time:
            ...
            SCORE_AFTER_DEATH = get_font(75).render(str(self.score), True, "#b68f40")

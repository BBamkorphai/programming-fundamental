...
class Player(pygame.sprite.Sprite):
    def __init__(self,pos,surface,create_jump_particles):
        ...
        # SFX
        self.SFX_laser = pygame.mixer.Sound('D:/survive! if you can/SFX and music/shoot_laser.wav')
        self.SFX_player_death = pygame.mixer.Sound('D:/survive! if you can/SFX and music/player_death.wav')

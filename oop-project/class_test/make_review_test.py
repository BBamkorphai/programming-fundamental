...
korphai = CustomerInfo("unused","unused","Prakrittipon", "Sommool", "korphaisk@gmail.com", "KMITL")
meawhod = CustomerInfo("unused","unused","prakonthakrit", "Picthaya", "meawnoy@gmail.com", "KMITL")
